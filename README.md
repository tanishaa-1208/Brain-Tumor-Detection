...
Brain Tumor Detection using Customised CNN with Explainable AI (SHAP, LIME, Grad-CAM)
Replicated exactly from the Heliyon 2024 research paper: “Utilising customised CNN for brain tumor prediction with explainable AI”.

# 🧠 Brain Tumor Detection Using CNN + XAI
This project implements a Customised Convolutional Neural Network (CNN) for brain tumor classification using MRI images, along with Explainable AI (XAI) techniques — SHAP, LIME, and Grad-CAM — to explain predictions.
...
- The dataset is uploaded manually and extracted into the /data folder.

✔ 2. Data Preprocessing
- Image resizing → (150×150×3)
- Normalisation → pixel/255
- Label encoding
- Train/Validation split → 90% / 10%

# 🧱 Customised CNN Architecture (from the research paper)
